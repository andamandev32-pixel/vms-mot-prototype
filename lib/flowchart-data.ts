...
const locationsFlow: PageFlowData = {
  ...
  summary: "จัดการโครงสร้างอาคาร แผนก (master data) และชั้น — แผนกสร้างอิสระก่อน แล้วชั้นค่อยเลือกว่ามีแผนกอะไร",
  flowcharts: [
    {
      id: "loc-hierarchy",
      title: "โครงสร้างลำดับชั้น",
      titleEn: "Building → Department (master) → Floor (assign dept)",
      description: "สร้างแผนกก่อน (master data) แล้วชั้นค่อยเลือกว่ามีแผนกใดบ้าง",
      steps: [
        { id: "s1", label: "เริ่มต้น", type: "start" },
        { id: "s2", label: "สร้าง/เลือกอาคาร\n(Building)", type: "process" },
        { id: "s3", label: "สร้างแผนก\n(Department — master data)\nไม่ต้องระบุชั้น", type: "process" },
        { id: "s4", label: "สร้าง/เลือกชั้น\n(Floor)\nเลือกแผนกที่อยู่ในชั้น", type: "process" },
  ...
  validationRules: [
    ...
    },
    {
      ...
      rules: [
        "ห้ามว่าง (Required)",
        "ความยาวไม่เกิน 100 ตัวอักษร",
        "ห้ามซ้ำทั้งระบบ (unique) — แผนกเป็น master data",
      ],
    },
    {
      field: "ชื่อชั้น",
  ...
  businessConditions: [
    {
      ...
      conditions: [
        ...
        "Floor ที่มี Department ผูกอยู่ → ต้องถอดแผนกออกก่อนลบชั้น",
        "Department เป็น master data — สามารถอยู่ได้โดยไม่ต้องผูกชั้น",
    ...
    },
    {
      ...
      description: "แผนกเป็น master data ที่ใช้ทั่วระบบ — ไม่ขึ้นกับชั้น/อาคาร",
      conditions: [
        ...
        "ชั้น (Floor) เลือกแผนกผ่าน floor_departments junction table",
      ],
    },
  ],
};
