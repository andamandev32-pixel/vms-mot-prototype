...
const userManagementFlow: PageFlowData = {
  ...
  summary: "จัดการบัญชีผู้ใช้ทั้งหมด — ดูรายชื่อ, เปลี่ยนสิทธิ์ (Role), ล็อก/ปลดล็อกบัญชี, รีเซ็ตรหัสผ่าน",
  summaryEn: "Manage all user accounts — view list, change role, lock/unlock, reset password",
  flowcharts: [
    {
      id: "um-register",
