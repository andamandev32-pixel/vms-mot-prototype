...
const visitSlipsApi: PageApiDoc = {
  ...
  endpoints: [
    {
      ...
      summary: "ดึงการตั้งค่า Visit Slip ปัจจุบัน",
      summaryEn: "Get visit slip configuration",
      auth: "admin",
      responseExample: `{
  ...
  "footer_text": "กรุณาติดบัตรให้เห็นชัดเจนตลอดเวลา",
  "slip_size": "A6",
  "expiry_display": true,
  "custom_fields": [
  ...
  "updated_at": "2026-01-20T10:00:00Z"
    ...
    },
    {
      method: "PUT",
      path: "/api/visit-slips/config",
      summary: "อัปเดตการตั้งค่า Visit Slip",
      summaryEn: "Update visit slip configuration",
      auth: "admin",
      requestBody: [
        ...
        { name: "logo_url", type: "string", required: false, description: "URL โลโก้" },
        ...
        { name: "slip_size", type: "string", required: false, description: "ขนาดบัตร: A6 | A7 | custom" },
        { name: "footer_text", type: "string", required: false, description: "ข้อความท้ายบัตร" },
        { name: "custom_fields", type: "CustomField[]", required: false, description: "ฟิลด์เพิ่มเติม" },
      ],
      notes: ["Singleton config — มีได้ 1 record", "บันทึก audit_log"],
    },
    {
      method: "GET",
      path: "/api/visit-slips/preview",
      summary: "พรีวิว Visit Slip ด้วยข้อมูลตัวอย่าง",
      summaryEn: "Preview visit slip with sample data",
      auth: "admin",
      responseExample: `{
  "preview_html": "<div class='visit-slip'>...</div>",
  "preview_image_url": "/api/visit-slips/preview.png"
}`,
      notes: ["ใช้ข้อมูล mock สำหรับ preview", "คืน HTML หรือ image URL สำหรับ frontend render"],
    },
  ],
};
