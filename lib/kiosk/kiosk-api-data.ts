  ...
  // ─── ID_VERIFICATION ───
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        summary: "Auto-match walk-in visitor กับนัดหมายของวันนี้ด้วยเลขบัตร — เรียกหลัง verify-identity เพื่อตรวจว่าผู้ที่เดิน walk-in มีนัดซ่อนอยู่หรือไม่",
        summaryEn: "Auto-match walk-in visitor against today's appointments by ID number — called after verify-identity to detect hidden appointments",
