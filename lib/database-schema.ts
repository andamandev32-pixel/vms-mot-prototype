  ...
  tables: [
    {
      ...
      columns: [
        ...
        { name: "show_on_line", type: "BOOLEAN", nullable: false, comment: "แสดงวัตถุประสงค์นี้บน LINE OA + Web App", defaultValue: "true" },
      ...
      seedData: [
        { id: 1, name: "ติดต่อราชการ", name_en: "Official Business", icon: "🏛️", is_active: true, show_on_line: true, show_on_kiosk: true, show_on_counter: true, allowed_entry_modes: "single,period", sort_order: 1 },
        { id: 2, name: "ประชุม / สัมมนา", name_en: "Meeting / Seminar", icon: "📋", is_active: true, show_on_line: true, show_on_kiosk: true, show_on_counter: true, allowed_entry_modes: "single,period", sort_order: 2 },
        { id: 3, name: "ส่งเอกสาร / พัสดุ", name_en: "Document / Parcel Delivery", icon: "📄", is_active: true, show_on_line: true, show_on_kiosk: true, show_on_counter: true, allowed_entry_modes: "single", sort_order: 3 },
        { id: 4, name: "ผู้รับเหมา / ซ่อมบำรุง", name_en: "Contractor / Maintenance", icon: "🔧", is_active: true, show_on_line: false, show_on_kiosk: true, show_on_counter: true, allowed_entry_modes: "single,period", sort_order: 4 },
        { id: 5, name: "สมัครงาน / สัมภาษณ์", name_en: "Job Application / Interview", icon: "💼", is_active: true, show_on_line: true, show_on_kiosk: true, show_on_counter: true, allowed_entry_modes: "single", sort_order: 5 },
        { id: 6, name: "เยี่ยมชม / ศึกษาดูงาน", name_en: "Study Visit / Tour", icon: "🎓", is_active: true, show_on_line: true, show_on_kiosk: false, show_on_counter: true, allowed_entry_modes: "single,period", sort_order: 6 },
        { id: 7, name: "รับ-ส่งสินค้า", name_en: "Delivery / Pickup", icon: "📦", is_active: true, show_on_line: false, show_on_kiosk: true, show_on_counter: true, allowed_entry_modes: "single", sort_order: 7 },
        { id: 8, name: "อื่นๆ", name_en: "Other", icon: "🔖", is_active: false, show_on_line: true, show_on_kiosk: true, show_on_counter: true, allowed_entry_modes: "single", sort_order: 8 },
      ],
    },
    {
      ...
      columns: [
        ...
        { name: "accept_from_line", type: "BOOLEAN", nullable: false, comment: "แผนกนี้รับจาก LINE OA + Web App", defaultValue: "true" },
      ...
      seedData: [
        // vpc-1: ติดต่อราชการ
        { id: 1, visit_purpose_id: 1, department_id: 1, require_person_name: true, require_approval: true, approver_group_id: 1, offer_wifi: true, accept_from_line: true, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 2, visit_purpose_id: 1, department_id: 2, require_person_name: true, require_approval: true, approver_group_id: 3, offer_wifi: true, accept_from_line: true, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 3, visit_purpose_id: 1, department_id: 3, require_person_name: true, require_approval: true, approver_group_id: 5, offer_wifi: true, accept_from_line: true, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 4, visit_purpose_id: 1, department_id: 4, require_person_name: true, require_approval: true, approver_group_id: 6, offer_wifi: false, accept_from_line: true, accept_from_kiosk: false, accept_from_counter: true, is_active: true },
        { id: 5, visit_purpose_id: 1, department_id: 5, require_person_name: true, require_approval: false, approver_group_id: null, offer_wifi: true, accept_from_line: true, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 6, visit_purpose_id: 1, department_id: 8, require_person_name: false, require_approval: false, approver_group_id: null, offer_wifi: false, accept_from_line: true, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 7, visit_purpose_id: 1, department_id: 9, require_person_name: true, require_approval: true, approver_group_id: 10, offer_wifi: true, accept_from_line: true, accept_from_kiosk: false, accept_from_counter: true, is_active: true },
        // vpc-2: ประชุม / สัมมนา
        { id: 8, visit_purpose_id: 2, department_id: 1, require_person_name: true, require_approval: true, approver_group_id: 1, offer_wifi: true, accept_from_line: true, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 9, visit_purpose_id: 2, department_id: 3, require_person_name: true, require_approval: true, approver_group_id: 5, offer_wifi: true, accept_from_line: true, accept_from_kiosk: false, accept_from_counter: true, is_active: true },
        { id: 10, visit_purpose_id: 2, department_id: 4, require_person_name: true, require_approval: false, approver_group_id: null, offer_wifi: true, accept_from_line: true, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 11, visit_purpose_id: 2, department_id: 9, require_person_name: true, require_approval: true, approver_group_id: 10, offer_wifi: true, accept_from_line: true, accept_from_kiosk: false, accept_from_counter: true, is_active: true },
        // vpc-3: ส่งเอกสาร / พัสดุ
        { id: 12, visit_purpose_id: 3, department_id: 1, require_person_name: false, require_approval: false, approver_group_id: null, offer_wifi: false, accept_from_line: true, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 13, visit_purpose_id: 3, department_id: 2, require_person_name: false, require_approval: false, approver_group_id: null, offer_wifi: false, accept_from_line: true, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 14, visit_purpose_id: 3, department_id: 4, require_person_name: true, require_approval: true, approver_group_id: 6, offer_wifi: false, accept_from_line: false, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        // vpc-4: ผู้รับเหมา
        { id: 15, visit_purpose_id: 4, department_id: 2, require_person_name: false, require_approval: true, approver_group_id: 4, offer_wifi: false, accept_from_line: false, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 16, visit_purpose_id: 4, department_id: 6, require_person_name: false, require_approval: true, approver_group_id: 9, offer_wifi: false, accept_from_line: false, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        // vpc-5: สมัครงาน
        { id: 17, visit_purpose_id: 5, department_id: 2, require_person_name: true, require_approval: false, approver_group_id: null, offer_wifi: false, accept_from_line: true, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        // vpc-6: เยี่ยมชม
        { id: 18, visit_purpose_id: 6, department_id: 4, require_person_name: true, require_approval: true, approver_group_id: 7, offer_wifi: true, accept_from_line: true, accept_from_kiosk: false, accept_from_counter: true, is_active: true },
        { id: 19, visit_purpose_id: 6, department_id: 5, require_person_name: true, require_approval: true, approver_group_id: 8, offer_wifi: true, accept_from_line: true, accept_from_kiosk: false, accept_from_counter: true, is_active: true },
        { id: 20, visit_purpose_id: 6, department_id: 7, require_person_name: false, require_approval: true, approver_group_id: null, offer_wifi: true, accept_from_line: true, accept_from_kiosk: false, accept_from_counter: true, is_active: false },
        // vpc-7: รับ-ส่งสินค้า
        { id: 21, visit_purpose_id: 7, department_id: 1, require_person_name: false, require_approval: false, approver_group_id: null, offer_wifi: false, accept_from_line: false, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 22, visit_purpose_id: 7, department_id: 2, require_person_name: false, require_approval: false, approver_group_id: null, offer_wifi: false, accept_from_line: false, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 23, visit_purpose_id: 7, department_id: 4, require_person_name: false, require_approval: false, approver_group_id: null, offer_wifi: false, accept_from_line: false, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        // vpc-8: อื่นๆ
        { id: 24, visit_purpose_id: 8, department_id: 1, require_person_name: false, require_approval: true, approver_group_id: 2, offer_wifi: false, accept_from_line: true, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
        { id: 25, visit_purpose_id: 8, department_id: 2, require_person_name: false, require_approval: true, approver_group_id: 3, offer_wifi: false, accept_from_line: true, accept_from_kiosk: true, accept_from_counter: true, is_active: true },
      ],
    },
    {
