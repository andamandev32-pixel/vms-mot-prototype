  ...
  tables: [
    {
      ...
      seedData: [
        { id: 1, name: "ติดต่อราชการ", name_en: "Official Business", icon: "🏛️", is_active: true, sort_order: 1 },
        { id: 2, name: "ประชุม / สัมมนา", name_en: "Meeting / Seminar", icon: "📋", is_active: true, sort_order: 2 },
        { id: 3, name: "ส่งเอกสาร / พัสดุ", name_en: "Document / Parcel Delivery", icon: "📄", is_active: true, sort_order: 3 },
        { id: 4, name: "ผู้รับเหมา / ซ่อมบำรุง", name_en: "Contractor / Maintenance", icon: "🔧", is_active: true, sort_order: 4 },
        { id: 5, name: "สมัครงาน / สัมภาษณ์", name_en: "Job Application / Interview", icon: "💼", is_active: true, sort_order: 5 },
        { id: 6, name: "เยี่ยมชม / ศึกษาดูงาน", name_en: "Study Visit / Tour", icon: "🎓", is_active: true, sort_order: 6 },
        { id: 7, name: "รับ-ส่งสินค้า", name_en: "Delivery / Pickup", icon: "📦", is_active: true, sort_order: 7 },
        { id: 8, name: "อื่นๆ", name_en: "Other", icon: "🔖", is_active: false, sort_order: 8 },
      ],
    },
    {
...
const accessZonesSchema: PageSchema = {
  ...
  tables: [
    ...
    },
    {
      ...
      seedData: [
        { id: 1, name: "ผู้เยี่ยมชมทั่วไป", name_en: "General Visitor", description: "เข้าได้เฉพาะล็อบบี้และพื้นที่ส่วนกลาง ชั้น 1", hikvision_group_id: "HIK-GRP-GENERAL", qr_code_prefix: "VMS-GEN", validity_minutes: 60, schedule_days_of_week: [1,2,3,4,5], schedule_start_time: "08:00", schedule_end_time: "17:00", color: "#6B7280", is_active: true },
        { id: 2, name: "ติดต่อราชการ ชั้น 2-5", name_en: "Official — Floor 2-5", description: "เข้าล็อบบี้ + สำนักงานชั้น 2-5", hikvision_group_id: "HIK-GRP-FL2-5", qr_code_prefix: "VMS-OFA", validity_minutes: 120, schedule_days_of_week: [1,2,3,4,5], schedule_start_time: "08:00", schedule_end_time: "17:00", color: "#6A0DAD", is_active: true },
        { id: 3, name: "ติดต่อราชการ ชั้น 6", name_en: "Official — Floor 6", description: "เข้าล็อบบี้ + ชั้น 6", hikvision_group_id: "HIK-GRP-FL6", qr_code_prefix: "VMS-OFB", validity_minutes: 120, schedule_days_of_week: [1,2,3,4,5], schedule_start_time: "08:00", schedule_end_time: "17:00", color: "#2563EB", is_active: true },
        { id: 4, name: "ติดต่อราชการ ชั้น 7-8", name_en: "Official — Floor 7-8", description: "เข้าล็อบบี้ + ชั้น 7-8", hikvision_group_id: "HIK-GRP-FL7-8", qr_code_prefix: "VMS-OFC", validity_minutes: 120, schedule_days_of_week: [1,2,3,4,5], schedule_start_time: "08:00", schedule_end_time: "17:00", color: "#059669", is_active: true },
        { id: 5, name: "ห้องประชุมรวม", name_en: "All Meeting Rooms", description: "เข้าได้เฉพาะห้องประชุมทุกชั้น (ไม่รวมห้องประชุมรัฐมนตรี)", hikvision_group_id: "HIK-GRP-MEETING", qr_code_prefix: "VMS-MTG", validity_minutes: 180, schedule_days_of_week: [1,2,3,4,5], schedule_start_time: "07:30", schedule_end_time: "18:00", color: "#0891B2", is_active: true },
        { id: 6, name: "VIP — สำนักงานรัฐมนตรี", name_en: "VIP — Minister's Office", description: "เข้าชั้น 9 (ต้องได้รับอนุมัติพิเศษ)", hikvision_group_id: "HIK-GRP-VIP", qr_code_prefix: "VMS-VIP", validity_minutes: 60, schedule_days_of_week: [1,2,3,4,5], schedule_start_time: "09:00", schedule_end_time: "16:00", color: "#DC2626", is_active: true },
        { id: 7, name: "ผู้รับเหมา / ซ่อมบำรุง", name_en: "Contractor / Maintenance", description: "เข้าพื้นที่ซ่อมบำรุง + ที่จอดรถ", hikvision_group_id: "HIK-GRP-MAINT", qr_code_prefix: "VMS-CTR", validity_minutes: 240, schedule_days_of_week: [1,2,3,4,5,6], schedule_start_time: "07:00", schedule_end_time: "18:00", color: "#92400E", is_active: true },
        { id: 8, name: "ที่จอดรถ", name_en: "Parking Only", description: "เข้าได้เฉพาะลานจอดรถ", hikvision_group_id: "HIK-GRP-PARK", qr_code_prefix: "VMS-PKG", validity_minutes: 480, schedule_days_of_week: [1,2,3,4,5], schedule_start_time: "06:00", schedule_end_time: "20:00", color: "#4B5563", is_active: true },
        { id: 9, name: "รับ-ส่งสินค้า", name_en: "Delivery / Pickup", description: "เข้าล็อบบี้ + ที่จอดรถ (จำกัดเวลา 30 นาที)", hikvision_group_id: "HIK-GRP-DELIVERY", qr_code_prefix: "VMS-DLV", validity_minutes: 30, schedule_days_of_week: [1,2,3,4,5,6], schedule_start_time: "06:00", schedule_end_time: "18:00", color: "#7C3AED", is_active: true },
      ],
    },
    {
  ...
  tables: [
    {
      ...
      columns: [
        { name: "id", type: "SERIAL", nullable: false, comment: "รหัสแบบฟอร์ม (PK)", isPrimaryKey: true },
    ...
    },
    {
      ...
      seedData: [
        ...
        { id: 1, template_id: 1, field_key: "visitorName", label: "ชื่อ-นามสกุล ผู้เยี่ยม", label_en: "Visitor Name", is_enabled: true, sort_order: 1 },
        { id: 2, template_id: 1, field_key: "visitorCompany", label: "บริษัท / หน่วยงาน", label_en: "Company", is_enabled: true, sort_order: 2 },
        { id: 3, template_id: 1, field_key: "idNumber", label: "เลขบัตร / Passport", label_en: "ID Number", is_enabled: true, sort_order: 3 },
        { id: 4, template_id: 1, field_key: "hostName", label: "ผู้ติดต่อ / ผู้รับ", label_en: "Host Name", is_enabled: true, sort_order: 4 },
        { id: 5, template_id: 1, field_key: "department", label: "แผนก / หน่วยงานที่พบ", label_en: "Department", is_enabled: true, sort_order: 5 },
        { id: 6, template_id: 1, field_key: "visitPurpose", label: "วัตถุประสงค์", label_en: "Visit Purpose", is_enabled: true, sort_order: 6 },
        { id: 7, template_id: 1, field_key: "visitDate", label: "วันที่เข้าพื้นที่", label_en: "Visit Date", is_enabled: true, sort_order: 7 },
        { id: 8, template_id: 1, field_key: "timeIn", label: "เวลาเข้า", label_en: "Time In", is_enabled: true, sort_order: 8 },
        { id: 9, template_id: 1, field_key: "timeOut", label: "เวลาที่ต้องออก", label_en: "Time Out", is_enabled: true, sort_order: 9 },
        { id: 10, template_id: 1, field_key: "accessZone", label: "โซนที่อนุญาต", label_en: "Allowed Zone", is_enabled: true, sort_order: 10 },
        { id: 11, template_id: 1, field_key: "bookingCode", label: "รหัสนัดหมาย", label_en: "Booking Code", is_enabled: true, sort_order: 11 },
      ],
    },
    {
      ...
      columns: [
        ...
        { name: "slip_template_id", type: "INT", nullable: true, comment: "FK → visit_slip_templates.id — null = ใช้แบบ default", isForeignKey: true, references: "visit_slip_templates.id" },
      ],
      seedData: [
        { visit_purpose_id: 1, slip_template_id: null },
        { visit_purpose_id: 2, slip_template_id: 2 },
        { visit_purpose_id: 3, slip_template_id: 3 },
        { visit_purpose_id: 4, slip_template_id: 5 },
        { visit_purpose_id: 5, slip_template_id: null },
        { visit_purpose_id: 6, slip_template_id: 4 },
        { visit_purpose_id: 7, slip_template_id: 3 },
        { visit_purpose_id: 8, slip_template_id: null },
      ],
    },
  ],
  relationships: [
