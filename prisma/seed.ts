  ...
  await prisma.$transaction(async (tx) => {
    ...
    await tx.visitPurposeDepartmentRule.createMany({
      data: [
        ...
        { visitPurposeId: 1, departmentId: 1, requirePersonName: true,  requireApproval: true,  approverGroupId: 1,    offerWifi: true,  acceptFromLine: true,  acceptFromWeb: true,  acceptFromKiosk: true,  acceptFromCounter: true,  isActive: true },
        { visitPurposeId: 1, departmentId: 2, requirePersonName: true,  requireApproval: true,  approverGroupId: 3,    offerWifi: true,  acceptFromLine: true,  acceptFromWeb: true,  acceptFromKiosk: true,  acceptFromCounter: true,  isActive: true },
        { visitPurposeId: 1, departmentId: 3, requirePersonName: true,  requireApproval: true,  approverGroupId: 3,    offerWifi: true,  acceptFromLine: true,  acceptFromWeb: true,  acceptFromKiosk: true,  acceptFromCounter: true,  isActive: true },
        { visitPurposeId: 1, departmentId: 4, requirePersonName: true,  requireApproval: true,  approverGroupId: 1,    offerWifi: false, acceptFromLine: true,  acceptFromWeb: true,  acceptFromKiosk: false, acceptFromCounter: true,  isActive: true },
        { visitPurposeId: 1, departmentId: 5, requirePersonName: true,  requireApproval: false, approverGroupId: null, offerWifi: true,  acceptFromLine: true,  acceptFromWeb: true,  acceptFromKiosk: true,  acceptFromCounter: true,  isActive: true },
        { visitPurposeId: 1, departmentId: 8, requirePersonName: false, requireApproval: false, approverGroupId: null, offerWifi: false, acceptFromLine: true,  acceptFromWeb: true,  acceptFromKiosk: true,  acceptFromCounter: true,  isActive: true },
        { visitPurposeId: 1, departmentId: 9, requirePersonName: true,  requireApproval: true,  approverGroupId: 3,    offerWifi: true,  acceptFromLine: true,  acceptFromWeb: true,  acceptFromKiosk: false, acceptFromCounter: true,  isActive: true },
